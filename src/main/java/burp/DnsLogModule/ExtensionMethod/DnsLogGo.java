...
public class DnsLogGo extends DnsLogAbstract {
    ...
    public DnsLogGo(IBurpExtenderCallbacks callbacks) {
        this.callbacks = callbacks;

        this.setExtensionName("DnsLogGo");
    ...
    public String export() {
        ...
        String str4 = String.format("dnsLogRecordsApi: %s <br/>", this.dnslogDomainName + "/api/getDnsData");
    ...
    public void consoleExport() {
        ...
        stdout.println(String.format("dnsLog保存记录的api接口: %s", this.dnslogDomainName + "/api/getDnsData"));
